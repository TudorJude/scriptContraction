...
if(arenaBonus > 0)
   ...
   {
   	log.debug("AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAARENABONUSSSSSSSSSSSS: " + arenaBonus);
   	log.debug("BBBBBBBAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAARENABONUSSSSSSSSSSSS: " + arenaBonus/100);
   	   	log.debug("CCCCCBEFORE: " + currencyUpdated.SC );
   	currencyUpdated.SC = Math.floor(Number(currencyUpdated.SC) + Number(currencyUpdated.SC) * (arenaBonus/100));
   	   	   	log.debug("DDDDDAFTER: " + currencyUpdated.SC );
